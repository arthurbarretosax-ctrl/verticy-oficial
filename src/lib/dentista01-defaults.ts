// Conteúdo padrão do template Dentista01 — usado ao trocar de template no painel.
export const DENTISTA01_DEFAULTS = {
  ...
  hero: {
    ...
    image_url:
      "https://placehold.co/1920x1080/1A1715/E3CCB7?text=Foto+de+Capa",
    image_mobile_url: "",
  ...
  resultados: {
    ...
    items: [
      {
        before_url: "https://placehold.co/800x600/3a3a3a/ffffff?text=Antes+1",
        after_url: "https://placehold.co/800x600/e3ccb7/2a2522?text=Depois+1",
      },
      {
        before_url: "https://placehold.co/800x600/3a3a3a/ffffff?text=Antes+2",
        after_url: "https://placehold.co/800x600/e3ccb7/2a2522?text=Depois+2",
      },
    ],
  },
  testimonials: {
    ...
    items: [
      {
        quote: "Está tão bonito… minha autoestima está melhor graças as suas mãos. Deus abençoe seu dom!!",
        name: "Jéssica de Oliveira",
        role: "Paciente",
      },
      {
        quote: "Simplesmente sensacional! Uma profissional paciente, dedicada e gentil. Que sorte encontrá-la!",
        name: "Ana Beatriz Verneque",
        role: "Paciente",
      },
    ],
  },
  faq: {
    ...
    items: [
      { q: "Atende convênios?", a: "No momento, o consultório não trabalha com convênios. Oferecemos condições de pagamento facilitadas para que você cuide do seu sorriso sem preocupação." },
      { q: "Como funciona o pagamento?", a: "Todos os procedimentos podem ser parcelados em até 12x no cartão de crédito. Após a consulta, apresentamos um plano de tratamento detalhado com os valores." },
      { q: "Preciso sentir dor para ir ao dentista?", a: "Não! Consultas de rotina e limpezas regulares são exatamente o que evita problemas dolorosos." },
    ],
  },
  consultorio: {
    eyebrow: "A Clínica",
  ...
  map: {
    ...
    embed_url:
      "https://maps.google.com/maps?q=Campos%20dos%20Goytacazes%20RJ&t=&z=13&ie=UTF8&iwloc=&output=embed",
  },
  contact: {
    footer_headline_pre: "Pronto para viver o seu",
    footer_headline_highlight: "melhor sorriso?",
    address_lines: [
      "Ed. Alexander Fleming",
      "R. Conselheiro Otaviano, 86 - Centro",
      "Campos dos Goytacazes - RJ, 28010-140",
    ],
...
export type Dentista01Content = typeof DENTISTA01_DEFAULTS;

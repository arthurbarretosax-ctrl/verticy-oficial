...
import "@/assets/css/yaveh.css";

export default function Yaveh({ content }: { content: any }) {
  return (
    <div className="yaveh-wrapper template-yaveh">
      <div className="relative overflow-x-hidden overflow-x-hidden selection:bg-yaveh-gold selection:text-yaveh-black pb-10">
  ...
  <div className="max-w-[480px] mx-auto min-h-screen relative sm:border-x sm:border-white/5 flex flex-col bg-yaveh-black shadow-2xl">
    ...
    <section id="especialista" className="px-6 py-20 reveal">
       <div className="glass-premium rounded-[3rem] overflow-hidden border border-yaveh-gold/10 shadow-2xl relative group bg-gradient-to-br from-yaveh-dark to-yaveh-black text-center">
          ...
          <div className="p-10 pt-6 relative z-10">
             ...
             <p className="text-[10px] font-bold text-yaveh-gold uppercase tracking-[0.3em] mb-6">{content.text_17}</p>
             
             <div className="space-y-5 text-[13px] text-yaveh-silver leading-relaxed font-light">
    ...
    <section className="px-6 py-20 bg-yaveh-dark/40 border-y border-yaveh-gold/10 reveal">
      <div className="text-center mb-12">
        <h2 className="font-display text-3xl text-white mb-2">{content.text_22}</h2>
        <p className="text-[10px] text-yaveh-gold uppercase tracking-widest font-bold">{content.text_23}</p>
      </div>

      <div className="grid grid-cols-1 gap-4">
        
        
        <div  className="glass-premium p-6 rounded-[2rem] border-l-[3px] border-l-yaveh-gold cursor-pointer group hover:bg-white/5 transition-all">
           <div className="flex gap-5 items-center">
              <div className="w-12 h-12 rounded-full bg-yaveh-gold/10 flex items-center justify-center border border-yaveh-gold/20 group-hover:bg-yaveh-gold/20 transition-colors">
                 <i data-lucide="baby" className="w-5 h-5 text-yaveh-gold"></i>
              </div>
              <div className="flex-1">
                 <h4 className="font-serif text-lg font-medium text-white mb-1">{content.text_24}</h4>
                 <p className="text-[11px] text-yaveh-silver font-light leading-relaxed">{content.text_25}</p>
              </div>
           </div>
        </div>

        
        <div  className="glass-premium p-6 rounded-[2rem] border-l-[3px] border-l-yaveh-white cursor-pointer group hover:bg-white/5 transition-all">
           <div className="flex gap-5 items-center">
              <div className="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center border border-white/10 group-hover:bg-white/10 transition-colors">
                 <i data-lucide="wind" className="w-5 h-5 text-white"></i>
              </div>
              <div className="flex-1">
                 <h4 className="font-serif text-lg font-medium text-white mb-1">{content.text_26}</h4>
                 <p className="text-[11px] text-yaveh-silver font-light leading-relaxed">{content.text_27}</p>
              </div>
           </div>
        </div>
        ...
        <div  className="glass-premium p-6 rounded-[2rem] border-l-[3px] border-l-yaveh-gold cursor-pointer group hover:bg-white/5 transition-all">
           <div className="flex gap-5 items-center">
              <div className="w-12 h-12 rounded-full bg-yaveh-gold/10 flex items-center justify-center border border-yaveh-gold/20 group-hover:bg-yaveh-gold/20 transition-colors">
                 <i data-lucide="brain" className="w-5 h-5 text-yaveh-gold"></i>
              </div>
              <div className="flex-1">
                 <h4 className="font-serif text-lg font-medium text-white mb-1">{content.text_28}</h4>
                 <p className="text-[11px] text-yaveh-silver font-light leading-relaxed">{content.text_29}</p>
              </div>
           </div>
        </div>
    ...
    <section className="py-16 bg-[#100E0C] border-t border-yaveh-gold/5">
       <div className="text-center mb-10 px-6 reveal">
          <h2 className="font-display text-3xl text-white mb-3">{content.text_30}</h2>
          <p className="text-[11px] text-yaveh-silver font-light max-w-[280px] mx-auto">{content.text_31}</p>
       </div>
       ...
       <div className="flex overflow-x-auto gap-5 px-6 hide-scrollbar snap-x pb-8">
          ...
          <div className="snap-center shrink-0 w-64 h-[26rem] rounded-[2.5rem] overflow-hidden relative shadow-2xl border border-yaveh-gold/10 bg-yaveh-dark text-white text-center reveal group">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-yaveh-black via-transparent to-transparent flex flex-col justify-end p-8">
               <p className="text-[9px] font-bold text-yaveh-gold uppercase tracking-[0.2em] mb-1">{content.text_32}</p>
               <h4 className="font-display text-xl italic text-white">{content.text_33}</h4>
            </div>
          </div>
          ...
          <div className="snap-center shrink-0 w-64 h-[26rem] rounded-[2.5rem] overflow-hidden relative shadow-2xl border border-yaveh-gold/10 bg-yaveh-dark text-white text-center reveal group">
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-yaveh-black via-transparent to-transparent flex flex-col justify-end p-8">
               <p className="text-[9px] font-bold text-yaveh-gold uppercase tracking-[0.2em] mb-1">{content.text_34}</p>
               <h4 className="font-display text-xl italic text-white">{content.text_35}</h4>
            </div>
          </div>
       </div>
    </section>
    ...
    <section className="px-6 py-20 relative overflow-hidden reveal">
      ...
      <div className="glass-premium border border-yaveh-gold/10 p-10 rounded-[3rem] shadow-2xl text-center relative overflow-hidden bg-yaveh-dark/50">
        ...
        <h3 className="font-display text-2xl font-medium text-white italic leading-snug mb-6 relative z-10">{content.text_36}</h3>
        
        <p className="text-xs text-yaveh-silver leading-relaxed font-light mb-8 relative z-10">{content.text_37}</p>
        ...
        <button  className="w-full bg-transparent border border-yaveh-gold/30 text-yaveh-gold py-4 rounded-2xl font-bold text-[10px] uppercase tracking-widest hover:bg-yaveh-gold/10 transition-all flex items-center justify-center gap-2 relative z-10">
          <i data-lucide="instagram" className="w-4 h-4"></i>{content.text_38}</button>
      </div>
    </section>
    ...
    <section className="px-6 py-16 border-t border-yaveh-gold/5 reveal">
      <div className="text-center mb-8 text-white">
        <h2 className="font-display text-2xl text-white">{content.text_39}</h2>
        <p className="text-[10px] text-yaveh-gold uppercase tracking-[0.3em] font-bold mt-2">{content.text_40}</p>
      </div>
      ...
      <div className="glass-premium p-3 rounded-[3rem] overflow-hidden shadow-2xl relative border-yaveh-gold/10 bg-yaveh-dark/40 text-center">
        ...
        <div className="p-8 text-center text-white">
          <p className="text-xs text-yaveh-silver font-medium mb-6 leading-relaxed">{content.text_41}<br />
            <span className="text-white block mt-1 font-semibold">{content.text_42}</span>
          </p>
          <div className="grid grid-cols-2 gap-3">
             <button  className="bg-yaveh-black border border-yaveh-gold/20 text-white py-4 rounded-2xl font-bold text-[10px] uppercase tracking-widest flex items-center justify-center gap-2 hover:bg-yaveh-gold/10 transition-colors">
                <i data-lucide="map-pin" className="w-3.5 h-3.5 text-yaveh-gold"></i>{content.text_43}</button>
             <button  className="bg-yaveh-black border border-yaveh-gold/20 text-white py-4 rounded-2xl font-bold text-[10px] uppercase tracking-widest flex items-center justify-center gap-2 hover:bg-yaveh-gold/10 transition-colors">
                <i data-lucide="navigation" className="w-3.5 h-3.5 text-yaveh-gold"></i>{content.text_44}</button>
          </div>
        </div>
      </div>
    </section>
    ...
    <section className="mt-auto px-8 pt-8 pb-20 bg-[#0C0B0A] border-t border-yaveh-gold/10 text-center reveal text-white rounded-t-[3rem] shadow-[0_-20px_40px_rgba(0,0,0,0.2)]">
      ...
      <h3 className="font-display text-2xl mb-8 text-white italic">{content.text_45}</h3>
      ...
      <div className="space-y-4 max-w-[280px] mx-auto">
        ...
        <button  className="w-full bg-yaveh-gold text-yaveh-black py-4 rounded-full font-bold text-[11px] uppercase tracking-widest shadow-[0_0_20px_rgba(217,197,178,0.2)] active:scale-[0.98] transition-all flex items-center justify-center gap-2">
          <i data-lucide="calendar-heart" className="w-4 h-4"></i>{content.text_46}</button>
      </div>

      <div className="mt-16 pt-8 border-t border-yaveh-gold/10 opacity-40 text-yaveh-silver text-center">
        <p className="text-[8px] font-bold uppercase tracking-[0.4em] mb-3">{content.text_47}</p>
        <p className="text-[8px] uppercase tracking-[0.3em]">{content.text_48}<strong className="text-yaveh-gold tracking-[0.2em] font-black">{content.text_49}</strong>{content.text_50}</p>
      </div>
    </section>
